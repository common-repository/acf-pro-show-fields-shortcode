...
class MXASTS_Model
{
	...
	* Table name
	*/
	protected $table = MXASTS_TABLE_SLUG;
	...
	*/
	public function mxasts_get_row( $table = NULL, $wher_name="", $wher_value="" )
	{
	...
	*/
	public function mxasts_get_results( $table = false, $wher_name = NULL, $wher_value = 1 )
	{
