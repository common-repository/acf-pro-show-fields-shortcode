...
Tags: ACF Pro, display fields, show fields, get fields
...
If you use ACF Pro, you can display some fields on your pages with shortcode. e.g. [mxasts_acfp_show_field debug="true" get_field="card" show_all_fields="true"]
...
1. ACF new group of field creation
2. Insert shortcode
3. Display custom fields
